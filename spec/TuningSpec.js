  ...
  describe("intervals", function() {
    describe("when the tuning contains a flat, it normalizes all notes with sharps to flats and", function() {
      it("returns a collection of objects describing a note, interval, color, and chord interval", function() {
        eb = new Tuning("EbADGBE", "Eb");
        expect(eb.intervals).toEqual([{ note: 'Eb', interval: '1', color: '#d10000', chordInterval: undefined, showInterval: false }, { note: 'E', interval: 'b2', color: '#FFFDE7', chordInterval: undefined, showInterval: false }, { note: 'F', interval: '2', color: '#ff6622', chordInterval: undefined, showInterval: false }, { note: 'Gb', interval: 'b3', color: '#E5E4D0', chordInterval: undefined, showInterval: false }, { note: 'G', interval: '3', color: '#ffda21', chordInterval: undefined, showInterval: false }, { note: 'Ab', interval: '4', color: '#33dd00', chordInterval: undefined, showInterval: false }, { note: 'A', interval: 'b5', color: '#BFBEAD', chordInterval: undefined, showInterval: false }, { note: 'Bb', interval: '5', color: '#1133cc', chordInterval: undefined, showInterval: false }, { note: 'B', interval: '#5', color: '#BAB9A9', chordInterval: undefined, showInterval: false }, { note: 'C', interval: '6', color: '#220066', chordInterval: undefined, showInterval: false }, { note: 'Db', interval: 'b7', color: '#7F7F74', chordInterval: undefined, showInterval: false }, { note: 'D', interval: '7', color: '#330044', chordInterval: undefined, showInterval: false }]);
      });
    });
    ...
    describe("when the tuning contains a sharp, it normalizes all notes with flats to sharps and", function() {
      it("returns a mapping of note intervals to all sharp normalized notes when the tuning contains a sharp", function() {
        algernon = new Tuning("DAEAC#E", "D");
        expect(algernon.intervals).toEqual([{ note: 'D', interval: '1', color: '#d10000', chordInterval: undefined, showInterval: false }, { note: 'D#', interval: 'b2', color: '#FFFDE7', chordInterval: undefined, showInterval: false }, { note: 'E', interval: '2', color: '#ff6622', chordInterval: undefined, showInterval: false }, { note: 'F', interval: 'b3', color: '#E5E4D0', chordInterval: undefined, showInterval: false }, { note: 'F#', interval: '3', color: '#ffda21', chordInterval: undefined, showInterval: false }, { note: 'G', interval: '4', color: '#33dd00', chordInterval: undefined, showInterval: false }, { note: 'G#', interval: 'b5', color: '#BFBEAD', chordInterval: undefined, showInterval: false }, { note: 'A', interval: '5', color: '#1133cc', chordInterval: undefined, showInterval: false }, { note: 'A#', interval: '#5', color: '#BAB9A9', chordInterval: undefined, showInterval: false }, { note: 'B', interval: '6', color: '#220066', chordInterval: undefined, showInterval: false }, { note: 'C', interval: 'b7', color: '#7F7F74', chordInterval: undefined, showInterval: false }, { note: 'C#', interval: '7', color: '#330044', chordInterval: undefined, showInterval: false }]);      
      });
    });
  });  
});